...
namespace DS4WinWPF
{
    ...
    public partial class App : Application
    {
        ...
        private void Application_Startup(object sender, StartupEventArgs e)
        {
            ...
            // Mostrar ventana de login antes de continuar
            if (!ShowLoginWindow())
            {
                runShutdown = false;
                Current.Shutdown();
        ...
        private bool ShowLoginWindow()
        {
            ...
            {
                MessageBox.Show($"Error al inicializar el sistema de autenticación: {ex.Message}", 
                    "DS4Windows - Error", MessageBoxButton.OK, MessageBoxImage.Error);
                return false;
            }
        }
    }
